...
int CG_stdexec(const SparseMatrix &A, CGData &data, const Vector &b, Vector &x,
  ...
  *color = 0;
  ...
  sender auto pre_loop_work = stdexec::starts_on(scheduler, stdexec::just()
  ...
  int k = 1;
  sender auto mg_point_0c = stdexec::starts_on(scheduler, stdexec::just() | MGP0c());
  sender auto mg_point_1c = stdexec::starts_on(scheduler, stdexec::just() | MGP1c());
  sender auto mg_point_2c = stdexec::starts_on(scheduler, stdexec::just() | MGP2c());
  sender auto mg_point_4a = stdexec::starts_on(scheduler, stdexec::just() | MGP4a());
  sender auto mg_point_5a = stdexec::starts_on(scheduler, stdexec::just() | MGP5a());
  sender auto mg_point_6a = stdexec::starts_on(scheduler, stdexec::just() | MGP6a());
  sender auto symgs_sweep_0 = stdexec::starts_on(scheduler, stdexec::just() | SYMGS_SWEEP_0());
  sender auto symgs_sweep_1 = stdexec::starts_on(scheduler, stdexec::just() | SYMGS_SWEEP_1());
  sender auto symgs_sweep_2 = stdexec::starts_on(scheduler, stdexec::just() | SYMGS_SWEEP_2());
  sender auto symgs_sweep_3 = stdexec::starts_on(scheduler, stdexec::just() | SYMGS_SWEEP_3());
  ...
  sender auto rest_of_first_loop = stdexec::starts_on(scheduler, stdexec::just()
  ...
  sender auto rest_of_loop = stdexec::starts_on(scheduler, stdexec::just()
    | then([=](){ *oldrtz = *rtz; })
    | COMPUTE_DOT_PRODUCT(r_vals[0], z_vals[0], rtz) //rtz = r'*z
